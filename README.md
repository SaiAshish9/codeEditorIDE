...
language code to judge0 submissions api and fetch the output of that data after sometime when it is completely executed using my submission token with the help of ajax calls.
